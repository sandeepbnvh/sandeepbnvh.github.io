		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsanportfoli-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsanportfoli-display": {
								"semanticObject": "comsanportfoli",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.san.portfoli",
									"url": sap.ui.require.toUrl("com/san/portfoli")
								}
							}
						}
					}
